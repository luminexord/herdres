...
def test_turn_with_matching_worker_in_different_space_is_not_cross_delivered(monkeypatch):
    ...
    spaces = [
        ...
        {"id": "space-contexto", "name": "contexto", "status": "active", "fingerprint": "space-contexto-fp"},
    ]
    tendwire = FakeTendwire(
        turns={
            "turns": [
...
def test_space_mode_repairs_stale_cross_topic_message_bindings(monkeypatch):
    ...
    store["spaces"] = {
        ...
        "space:space-contexto": {
            "source": "tendwire",
            "entry_type": "space",
            "tendwire_space_id": "space-contexto",
            "space_id": "space-contexto",
            "topic_id": "9988",
            "topic_name": "contexto",
        },
