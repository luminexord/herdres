...
SOURCE_FILES = {
    ...
    "herdres_connector/doctor.py": "# connector doctor\n",
    "herdres_connector/formatter.py": "# connector formatter\n",
    "herdres_connector/source_state.py": "# connector source state\n",
    "herdres_connector/telegram_delivery.py": "# connector telegram delivery\n",
    "herdres_connector/tendwire_client.py": "# connector tendwire client\n",
